...
def CNNAutoEncoder_96(optimizer, dimension, learning_rate, activation='sigmoid', loss='mse'):
    filter_size = 0
    channel = 0
    if dimension == 4:
        filter_size = 12; channel = 1
    elif dimension == 8:
        filter_size = 12; channel = 2
    elif dimension == 16:
        filter_size = 6; channel = 1
    elif dimension == 32:
        filter_size = 6; channel = 2
